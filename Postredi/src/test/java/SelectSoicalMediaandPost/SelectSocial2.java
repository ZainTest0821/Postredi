...
public class SelectSocial2 {
    public WebDriver driver;


    public SelectSocial2(WebDriver driver) throws InterruptedException, IOException {
        this.driver = driver;
        ...
        caption.sendKeys("Forgiveness is the power to choose how things affect you.");
        ...
        String autoItScriptPath = "C:\\Scripts\\SocialSelects2.exe";
